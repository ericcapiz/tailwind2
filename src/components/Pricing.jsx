      ...
      <div className="max-w-[1240px] mx-auto py-12">
        <div className="text-center py-8 text-slate-300">
          ...
          <p className="text-3xl">
            ...
            nihil iusto veritatis animi porro aspernatur rerum, fugit cumque
            itaque vitae libero doloribus cupiditate quidem obcaecati
            consequuntur earum reiciendis omnis.
          </p>
        </div>
